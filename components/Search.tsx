    ...
    <div className="view-section active flex-1 p-8 md:p-20 flex flex-col items-center justify-start h-full">
      <div className="w-full max-w-2xl">
        <div className="relative mb-8">
          ...
          <input 
            type="text" 
            placeholder="Search scenes, characters, or dialogue..." 
        ...
        <div className="space-y-2">
          <div className="text-xs font-medium text-zinc-500 px-2 mb-2">RECENT</div>
          <div onClick={() => navigateTo('editor')} className="flex items-center justify-between p-3 hover:bg-zinc-900 rounded-lg cursor-pointer transition group">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-zinc-300 group-hover:text-zinc-100">Scene 002 - Cockpit</span>
            </div>
            <span className="text-xs text-zinc-600">The Last Signal</span>
          </div>
          <div onClick={() => navigateTo('characters')} className="flex items-center justify-between p-3 hover:bg-zinc-900 rounded-lg cursor-pointer transition group">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-zinc-300 group-hover:text-zinc-100">Aria</span>
            </div>
            <span className="text-xs text-zinc-600">Character</span>
          </div>
        </div>
      </div>
    </div>
